    ...
    <div class="id-form">
      ...
      <v-form v-model="valid" @submit.prevent="findId">
        ...
        <v-text-field
          ...
          outlined clearable
        ></v-text-field>
        <v-btn @click="sendEmailCode" :disabled="waiting" block depressed class="send-code-btn">
        ...
        <v-btn type="submit" block depressed color="primary" class="btn-submit">비밀번호 변경하기</v-btn>
      </v-form>
    </div>
  </v-container>
</template>
